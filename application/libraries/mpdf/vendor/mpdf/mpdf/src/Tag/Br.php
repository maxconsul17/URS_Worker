	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		if ($this->mpdf->tableLevel) {
			...
			if (!isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['maxs'])) {
				$this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['maxs'] = isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s']) ? $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s'] : 0;
			} elseif ($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['maxs'] < isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s']) ? $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s'] : 0) {
				$this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['maxs'] = isset($this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s']) ? $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['s'] : 0;
			}
